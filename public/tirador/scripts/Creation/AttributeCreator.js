...
AttributeCreator.prototype.create = function() {
	//id, hp, damageReceived, damageDealtMultiplier
	TopLevel.attributesGetter.setAttributes("Ship", 10, 1, 10);
	TopLevel.attributesGetter.setAttributes("Ship", 10, 1, 10);
	TopLevel.attributesGetter.setAttributes("Ship", 10, 1, 10);

	TopLevel.attributesGetter.setAttributes("PartnerShip", 10, 1, 10);
	TopLevel.attributesGetter.setAttributes("PartnerShip", 10, 1, 10);
	TopLevel.attributesGetter.setAttributes("PartnerShip", 10, 1, 10);
	
	TopLevel.attributesGetter.setAttributes("PowerShip", 10, 1, 10);
	TopLevel.attributesGetter.setAttributes("PowerShip", 10, 1, 10);
	TopLevel.attributesGetter.setAttributes("PowerShip", 10, 1, 10);
	...
	TopLevel.attributesGetter.setAttributes("BeamCollider", 1, 0, 1);
	TopLevel.attributesGetter.setAttributes("BeamCollider_PowerBeam", 1, 0, 1);
